...
@section('title', 'FirstBlog - Freelance and life :: ' . $tag->title)
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <h2> Тэг: {{ $tag->title }} <small class="hidden-xs-down hidden-sm-down">Блог и фрилансе, дополнительном заработке и жизни </small></h2>
                </div><!-- end col -->
